...
export const TrainingPageHeader: FunctionComponent = () => {
  const [selctedSource, setSelectedSource] = useState<"all" | "internal" | "external">(
    "all"
  );
  ...
  return (
    <div className="space-y-3">
      ...
      <div className="relative">
        <div className="absolute h-full flex flex-col justify-center pl-5">
          <svg
        ...
        <input
          placeholder="Search..."
          className="px-14 py-[0.75rem] dark:bg-zinc-900/70 rounded-lg w-full focus:ring-2 dark:focus:ring-indigo-500 outline-none"
        />
      </div>
    </div>
  );
...
const FilterDropdownMenu: FunctionComponent = () => {
  return (
    <DropdownMenu.Root>
