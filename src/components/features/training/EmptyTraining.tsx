...
export const EmptyTraining: FunctionComponent<EmptyTrainingProps> = ({
  filter,
  info,
}) => {
  return (
    <div className="w-full px-10 py-40 flex flex-col items-center justify-center gap-5">
      {filter === "all" ? (
        <svg
          ...
          height="7em"
          viewBox="0 0 24 24"
          className="dark:text-indigo-700"
        >
          <path
            fill="none"
            stroke="currentColor"
        ...
        >
          <g fill="none" stroke="currentColor" strokeWidth="1.5">
            <path d="M18 6v4.853c0 .29 0 .435-.095.494c-.095.058-.224-.007-.484-.136l-1.242-.622c-.088-.043-.132-.065-.179-.065c-.047 0-.091.022-.179.065l-1.242.622c-.26.13-.39.194-.484.136c-.095-.06-.095-.204-.095-.494V6"></path>
            <path
              strokeLinecap="round"
              d="M22 11.798c0-2.632 0-3.949-.77-4.804a2.984 2.984 0 0 0-.224-.225C20.151 6 18.834 6 16.202 6h-.374c-1.153 0-1.73 0-2.268-.153a4 4 0 0 1-.848-.352C12.224 5.224 11.816 4.815 11 4l-.55-.55c-.274-.274-.41-.41-.554-.53a4 4 0 0 0-2.18-.903C7.53 2 7.336 2 6.95 2c-.883 0-1.324 0-1.692.07A4 4 0 0 0 2.07 5.257C2 5.626 2 6.068 2 6.95M21.991 16c-.036 2.48-.22 3.885-1.163 4.828C19.657 22 17.771 22 14 22h-4c-3.771 0-5.657 0-6.828-1.172C2 19.657 2 17.771 2 14v-3"
            ></path>
        ...
        >
          <g fill="none" stroke="currentColor" strokeLinecap="round" strokeWidth="1.5">
            <path d="M22 11.798c0-2.632 0-3.949-.77-4.804a2.984 2.984 0 0 0-.224-.225C20.151 6 18.834 6 16.202 6h-.374c-1.153 0-1.73 0-2.268-.153a4 4 0 0 1-.848-.352C12.224 5.224 11.816 4.815 11 4l-.55-.55c-.274-.274-.41-.41-.554-.53a4 4 0 0 0-2.18-.903C7.53 2 7.336 2 6.95 2c-.883 0-1.324 0-1.692.07A4 4 0 0 0 2.07 5.257C2 5.626 2 6.068 2 6.95M21.991 16c-.036 2.48-.22 3.885-1.163 4.828C19.657 22 17.771 22 14 22h-4c-3.771 0-5.657 0-6.828-1.172C2 19.657 2 17.771 2 14v-3"></path>
            <path strokeLinejoin="round" d="m10 13.5l1.333 1.5L14 12"></path>
          </g>
        </svg>
      ) : (
        <></>
      ...
      <h1 className="text-4xl font-medium dark:text-zinc-600">{info}</h1>
    </div>
  );
};
